...
insert into account(account_number, balance,blocked,creation_date,client_id) values ('1111',1000,false,to_date('2017.11.06.','YYYY.MM.DD.'),1);
insert into account(account_number, balance,blocked,creation_date,client_id) values ('2222',1000,false,to_date('2017.11.05.','YYYY.MM.DD.'),1);
insert into account(account_number, balance,blocked,creation_date,client_id) values ('3333',1000,false,to_date('2017.11.04.','YYYY.MM.DD.'),2);
insert into account(account_number, balance,blocked,creation_date,client_id) values ('4444',1000,false,to_date('2017.11.03.','YYYY.MM.DD.'),3);
insert into account(account_number, balance,blocked,creation_date,client_id) values ('5555',1000,false,to_date('2017.11.02.','YYYY.MM.DD.'),4);
